...
public class FileUtils {
    ...
    public static void writeBytes(byte[] array) {
        ...
        try {
            ...
            writer = new FileOutputStream(Environment.getExternalStorageDirectory() +
                    "/codec.h264", true);
            writer.write(array);
            writer.write('\n');
        } catch (IOException e){
    ...
    public static String writeContent(byte[] array) {
        ...
        try {
            ...
            writer = new FileWriter(Environment.getExternalStorageDirectory() +
                    "/codecH264.txt", true);
